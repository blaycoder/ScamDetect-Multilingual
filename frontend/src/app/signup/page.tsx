    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-16">
        <motion.div
          ...
          className="w-full max-w-md text-center glass-panel p-10"
        >
          <div className="mb-4 flex justify-center">
            <CheckCircle
              className="h-12 w-12 text-[#00f0ff]"
              strokeWidth={1.5}
            />
          </div>
          <h2 className="font-mono text-xl font-bold text-[#e2e8ff]">
            Verify Your Email
          </h2>
          <p className="mt-3 text-sm text-[#6b7280]">
            We sent a confirmation link to{" "}
            <span className="text-[#00f0ff]">{email}</span>. Click the link in
            your inbox to activate your account.
          </p>
          <button
            onClick={() => router.push("/login")}
            className="mt-6 inline-block rounded border border-[rgba(0,240,255,0.3)] px-6 py-2.5 font-mono text-sm text-[#00f0ff] hover:bg-[rgba(0,240,255,0.08)] transition-colors"
          >
            Go to Login
          </button>
        </motion.div>
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      ...
      >
        ...
        <div className="mb-8 text-center">
          <div className="mb-4 flex justify-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-full border border-[rgba(255,0,255,0.3)] bg-[rgba(255,0,255,0.08)]">
              <Shield className="h-7 w-7 text-[#ff00ff]" strokeWidth={1.5} />
            </div>
          </div>
        ...
        <div className="glass-panel p-8">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded border border-[rgba(255,0,255,0.15)] bg-[rgba(255,0,255,0.03)] py-2.5 pl-9 pr-3 font-mono text-sm text-[#e2e8ff] placeholder-[#3a3a5c] focus:border-[rgba(255,0,255,0.4)] focus:outline-none focus:ring-1 focus:ring-[rgba(255,0,255,0.15)] transition-colors"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded border border-[rgba(255,0,255,0.4)] bg-[rgba(255,0,255,0.1)] py-2.5 font-mono text-sm font-semibold text-[#ff00ff] transition-all hover:bg-[rgba(255,0,255,0.18)] active:scale-[0.98] disabled:opacity-50"
            >
